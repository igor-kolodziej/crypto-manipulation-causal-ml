...
The continuous outcome is the 10-minute logarithmic return. Signal features—hype intensity, urgency index, and instruction density—are analyzed as treatments. Market capitalization, pre-event volume, coin age, and the remaining signal features act as observed controls.
